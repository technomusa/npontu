...
function Kedebah() {
  ...
  return (
    <div className="scrollbar-hiding dome bg-slate-600/10 overflow-y-auto">
      <header className="fixed w-full top-0 z-50 mb-40">
        <nav className="bg-white shadow-xl border-gray-200 px-4 lg:px-6 py-2.5 ">
          <div className="flex flex-wrap  justify-between items-center mx-auto max-w-screen-xl">
            <div cldivssName="flex items-center">
            ...
            >
              ...
              <Link
                to="/signin"
                className="flex text-black bg-transparent border border-blue hover:border-transparent  hover:bg-green-500 hover:text-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2  focus:outline-none  items-center"
              >
                {/* <Unicons.UilSignin /> */}
                Sign In
              </Link>
              <Link
                to="/signup"
                className="flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2  focus:outline-none  items-center"
              >
                {/* <Unicons.UilSignin /> */}
                Sign Up
              </Link>
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                  <a
                    href="#"
                    className="hidden py-2 pr-4 pl-3 text-white rounded bg-blue-700 lg:bg-transparent lg:text-blue-700 lg:p-0 "
                    aria-current="page"
                  >
                    Home
                  </a>
                ...
                <li>
                  <a
                    href="#"
                    className="hidden py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0"
                  >
                    Company
                  </a>
                </li>
      ...
      <section className="h-[100vh] bg-[url('https://www.kedebah.com/landing/images/dbrr-min-_1_.webp')] bg-cover">
        {/* <div className="px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20 bg-clip-padding bg-opacity-60 border border-gray-200 backdrop-blur-md"> */}
        {/* <div className="flex backdrop-blur-sm bg-black/20 h-full"> */}
        {/* <div className="flex justify-center max-w-screen-xl  px-4 py-8 mx-auto xl:gap-0 lg:py-10 lg:grid-cols-12 ">
              <div className="mr-auto p-10 place-self-center lg:col-span-6">
                <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl ">
                  KEDEBAH ERP WITH SNWOLLEY (AI)
                </h1>
                <p className="max-w-2xl mb-6 font-light text-black/50 lg:mb-8 md:text-lg lg:text-xl ">
                  Cloud Based Artificial Intelligence Enterprise Resource
                  Planning
                </p>
                <p className="max-w-2xl mb-6 font-light text-black/50 lg:mb-8 md:text-lg lg:text-xl ">
                  Kedebah is a comprehensive Enterprise Resource Planning (ERP)
                  that handles all aspects of a company’s operational processes.
                  Various organisations use Kedebah to manage day-to-day
                  business activities such as accounting, inventory and sales
                  distribution, customer relationship management, human resource
                  management and payroll, procurement, project management, risk
                  management and compliance, and supply chain operations.
                  Kedebah ties together multitude business processes and enables
                  the flow of data between them. Thus, eliminating data
                  duplication and provide data integrity with a single source of
                  truth. With the Kedebah ERP all departments within your
                  organisation communicate with each other seamlessly while
                  operating at full capacity with modules and features tailored
                  to improve workflows.
                </p>
                <a
                  href="#"
                  className=" gap-1 inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 "
                >
                  Explore
                </a>
                <a
                  href="#"
                  className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-200 focus:ring-4 focus:ring-gray-100"
                >
                  See Live Demo
                </a>
              </div>
        ...
        {/* <div
          ...
          min-h-screen
          [ p-4 md:p-6 lg:p-8 ]
          [ flex justify-center items-center ] px-4 py-60 mx-10 bg-white shadow-lg sm:rounded-3xl  bg-opacity-60 border-gray-200 backdrop-blur-md
        "
        >
          //  w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 

          <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">
            KEDEBAH ERP WITH SNWOLLEY (AI)
          </h5>
          <p className="text-base text-gray-500 mb-5 md:text-lg lg:text-xl ">
            Cloud Based Artificial Intelligence Enterprise Resource Planning
          </p>
          <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">
            Kedebah is a comprehensive Enterprise Resource Planning (ERP) that
            handles all aspects of a company’s operational processes. Various
            organisations use Kedebah to manage day-to-day business activities
            such as accounting, inventory and sales distribution, customer
            relationship management, human resource management and payroll,
            procurement, project management, risk management and compliance, and
            supply chain operations. Kedebah ties together multitude business
            processes and enables the flow of data between them. Thus,
            eliminating data duplication and provide data integrity with a
            single source of truth. With the Kedebah ERP all departments within
            your organisation communicate with each other seamlessly while
            operating at full capacity with modules and features tailored to
            improve workflows.
          </p>
        ...
        <div className="flex backdrop-blur-sm bg-black/20 h-full">
          <div class="container mx-auto flex px-40 py-14 items-center justify-center flex-col">
            <h5
              class="text-3xl font-bold text-gray-900 dark:text-white
            max-w-xl mb-10 leading-none md:text-5xl xl:text-6xl "
            >
              KEDEBAH ERP WITH SNWOLLEY (AI)
            </h5>
            <p className="text-base text-white/80 mb-5 md:text-lg lg:text-xl ">
              Cloud Based Artificial Intelligence Enterprise Resource Planning.
            </p>
            {/* <p class="mb-5 text-base text-white/80 sm:text-lg ">
              Kedebah is a comprehensive Enterprise Resource Planning (ERP) that
              handles all aspects of a company’s operational processes. Various
              organisations use Kedebah to manage day-to-day business activities
              such as accounting, inventory and sales distribution, customer
              relationship management, human resource management and payroll,
              procurement, project management, risk management and compliance,
              and supply chain operations. Kedebah ties together multitude
              business processes and enables the flow of data between them.
              Thus, eliminating data duplication and provide data integrity with
              a single source of truth. With the Kedebah ERP all departments
              within your organisation communicate with each other seamlessly
              while operating at full capacity with modules and features
              tailored to improve workflows.
            </p> */}
            <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
              <a
                href="#"
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white hover:text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-200 focus:ring-4 focus:ring-gray-100"
              >
                See Live Demo
              </a>
            </div>
      ...
      <section className=" mt-10 ">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            {/* <img
              className="w-full h-[60vh] bg-cover bg-origin-content bg-center rounded-lg"
              src="https://www.kedebah.com/landing/images/franc-min-_1_.webp"
              alt="office content 1"
            /> */}
            <div className="w-[40vh] h-[60vh] bg-cover  bg-center rounded-lg bg-[url('https://www.kedebah.com/landing/images/franc-min-_1_.webp')]"></div>
            <div className="w-[40vh] h-[60vh] mt-4 lg:mt-10 bg-cover  bg-center rounded-lg bg-[url('https://www.kedebah.com/landing/images/modu.jpg')]"></div>
            {/* <img
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold ">Human Resource Module</h3>
              <p className="text-gray-500 ">
                Human resource module is used to track different people-related
                functions, such as planning, payroll, administration,
                development, hiring and more.
              </p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 ">
              ...
              <p className="text-gray-500 ">
                This module acts as a single repository to bring all sales,
                marketing, customer support activities together, and streamlines
                your process, policy, and customer support units
              </p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 ">
              ...
              <h3 className="mb-2 text-xl font-bold ">Inventory Module</h3>
              <p className="text-gray-500 ">
                Our Inventory & Sales module facilitates the maintenance of the
                appropriate level of stock in a warehouse. It also allows for
                the issuing of proforma and actual invoices to clients upon
                request and in confirming sales order.
              </p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 ">
              ...
              <p className="text-gray-500 ">
                With this module, you get to : Manage review of all projects
            ...
            <div>
              ...
              <p className="text-gray-500 ">
                Asset management is a systematic process of developing,
                operating, maintaining, upgrading and disposing of assets cost -
                effectively.
              </p>
            </div>
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold ">Finance Module</h3>
              <p className="text-gray-500 ">
                Pre-installed valuable tax brackets and statutory payroll
                deductions required by law (NHIL, GETFUND, VAT, VAT WITHHOLDING,
                COPORATE TAX WITHHOLDING).
              </p>
            </div>
            ...
            {readMore === 1 ? (
              <>
                <div>
                  ...
                  <h3 className="mb-2 text-xl font-bold ">Payroll Module</h3>
                  <p className="text-gray-500 ">
                    Our Payroll handles hourly and salaried employees using
                    daily, weekly, bi- weekly, semi-monthly, monthly, quarterly,
                    semi-annual, and annual pay periods.
                  </p>
                </div>
                <div>
                  <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 ">
                  ...
                  <p className="text-gray-500 ">
                    This module facilitates the day-to-day operations such as
                    purchase orders, item receipt, inventory management, vendor
                ...
                <div>
                  ...
                  <h3 className="mb-2 text-xl font-bold ">
                    Ecommerce & Social Media Posting
                  </h3>
                  <p className="text-gray-500 ">
                    Focuses on posting inventory online, open the business to
                    new revenue pools, customer growth and streamline online
                    order purchases and delivery
                  </p>
                </div>
                <div>
                  <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 ">
                  ...
                  <h3 className="mb-2 text-xl font-bold ">Retail module</h3>
                  <p className="text-gray-500 ">
                    Our retail module tends to offer a user - friendly Point of
                    Sale service which aims to fully integrate all departments
                    of a retail organization, its loyalty Customer and offer all
                    functions required to model business processes.
                  </p>
                </div>
                <div>
                  <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 ">
                  ...
                  <h3 className="mb-2 text-xl font-bold ">Wholesale module</h3>
                  <p className="text-gray-500 ">
                    The wholesale module plays a vital role in the supply chain
                    for your products, buying goods in bulk from manufacturers
                    and selling them to retailers and other businesses. With
                    this module, users are able to acquire goods, store them,
                    prepare them for sale in smaller quantities to their
                ...
                <div>
                  ...
                  <h3 className="mb-2 text-xl font-bold ">Warehouse module</h3>
                  <p className="text-gray-500 ">
                    With this module you are able to track exact stock within
                    one storage location, increase transparency across the
                    supply chain, provide precise data and improve collaboration
                    amongst team members, thus, ensuring a productive and
                    profitable business.
                  </p>
                </div>
                <div>
                  ...
                  <h3 className="mb-2 text-xl font-bold ">Depot module</h3>
                  <p className="text-gray-500 ">
                    This module provides key information to make operations
                    within retail or POS outlets quicker and easier to implement
                    with regards to bulk inventory updates, transfers and offers
          ...
          <div className="mt-6 items-center justify-center w-full space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
            <button
              type="button"
              className="
         inline-flex items-center font-medium text-blue-600 hover:text-blue-800

              justify-center px-5 py-3 text-base  text-center  border border-white rounded-lg hover:bg-gray-200 focus:ring-2 focus:ring-gray-600"
              onClick={() => (readMore === 1 ? setReadMore(0) : setReadMore(1))}
            >
              {readMore === 0 ? "Read More" : "Read Less"}
            </button>
          </div>
        </div>
      </section>
            ...
            <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
              <div class="px-4 py-6">
                <div class="flex items-start">
                  <svg
                    class="flex-shrink-0 w-12 h-12 text-zinc-700"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
      ...
      <section class="py-10 bg-white sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="max-w-xl mx-auto text-center">
            <h2 class="text-4xl font-bold text-black lg:text-5xl sm:text-5xl">
              Pricing &amp; Plans
            </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th class="px-4 py-8 text-center">
                    ...
                    <p class="mt-2 text-xl font-bold">Gh₵ 10</p>
                  ...
                  <th class="px-4 py-8 text-center">
                    ...
                    <p class="mt-2 text-xl font-bold">Gh₵ 50</p>
                    <p class="mt-1 text-sm font-normal text-gray-500">
                      {" "}
                      Per month{" "}
                    </p>
                  ...
                  <th class="px-4 py-8 text-center bg-gray-900 rounded-t-xl">
                    ...
                    <p class="mt-6 text-6xl font-bold text-white">Gh₵ 70</p>
                  ...
                  <th class="px-4 py-8 text-center">
                    ...
                    <p class="mt-2 text-xl font-bold">Gh₵ 85</p>
                    <p class="mt-1 text-sm font-normal text-gray-500">
                      {" "}
                      Per month{" "}
                    </p>
                  ...
                  <th class="px-4 py-8 text-center">
                    ...
                    <p class="mt-2 text-xl font-bold">Gh₵ 100</p>
                    <p class="mt-1 text-sm font-normal text-gray-500">
                      {" "}
                      Per month{" "}
                    </p>
                  ...
                  <th class="px-4 py-8 text-center">
                    ...
                    <p class="mt-2 text-xl font-bold">Gh₵ 135</p>
                    <p class="mt-1 text-sm font-normal text-gray-500">
                      {" "}
                      Per month{" "}
                    </p>
        ...
        <div class="block mt-12 border-t border-b border-gray-200 divide-y divide-gray-200 lg:hidden">
          <div class="grid grid-cols-4 text-center divide-x divide-gray-200">
            <div class="px-2 py-2">
              <span class="text-sm font-medium text-blue-600"> BASIC </span>
              <p class="mt-2 text-xl font-bold">Gh₵ 10</p>
            ...
            <div class="px-2 py-2">
              <span class="text-sm font-medium text-blue-600"> STANDARD </span>
              <p class="mt-2 text-xl font-bold">Gh₵ 50</p>
              <span class="mt-1 text-sm font-normal text-gray-500">
                {" "}
                Per month{" "}
            ...
            <div class="px-2 py-2">
              ...
              <p class="mt-2 text-xl font-bold">Gh₵ 70</p>
              <span class="mt-1 text-sm font-normal text-gray-500">
                {" "}
                Per month{" "}
              </span>
            ...
            <div class="px-2 py-2">
              <span class="text-sm font-medium text-blue-600"> PREMIUM </span>
              <p class="mt-2 text-xl font-bold">Gh₵ 85</p>
              <span class="mt-1 text-sm font-normal text-gray-500">
                {" "}
                Per month{" "}
            ...
            <div class="px-2 py-2">
              <span class="text-sm font-medium text-blue-600"> MASTER </span>
              <p class="mt-2 text-xl font-bold">Gh₵ 135</p>
              <span class="mt-1 text-sm font-normal text-gray-500">
                {" "}
                Per month{" "}
          ...
          <div class="px-2 py-4 sm:px-4">
            <p class="font-semibold">Package Size</p>
          </div>

          <div class="grid grid-cols-4 text-center divide-x divide-gray-200">
            <div class="px-2 py-2">01 employee</div>

            <div class="px-2 py-2">05 employees</div>

            <div class="px-2 py-2">05 employees</div>

            <div class="px-2 py-2">10 employees</div>
            <div class="px-2 py-2">12 employees</div>
            <div class="px-2 py-2">15 employees</div>
          </div>

          <div class="px-2 py-4 sm:px-4">
            <p class="font-semibold">Inventory Manager</p>
          </div>
          ...
          <div class="px-2 py-4 sm:px-4">
            <p class="font-semibold">Project Tracker</p>
          </div>
          ...
          <div class="px-2 py-4 sm:px-4">
            <p class="font-semibold">Payroll Manager</p>
          </div>
      ...
      <section className="bg-white bg-[url('https://www.kedebah.com/landing/images/getty.webp')] bg-cover">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <a
              href="#"
              className="text-white bg-green-500 hover:bg-green-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  focus:outline-none "
            >
              Contact Sales
            </a>
          </div>
